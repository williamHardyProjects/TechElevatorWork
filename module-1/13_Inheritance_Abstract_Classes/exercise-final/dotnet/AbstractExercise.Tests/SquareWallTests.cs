...
namespace AbstractExercise.Tests
{
    ...
    {
        private static readonly Type typeSquare = SafeReflection.GetType("SquareWall", "AbstractExercise");
        private static readonly Type typeRectangle = SafeReflection.GetType("RectangleWall", "AbstractExercise");
        private static readonly Type typeWall = SafeReflection.GetType("Wall", "AbstractExercise");
